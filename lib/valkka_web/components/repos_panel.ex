    ...
    <aside class="valkka-sidebar">
      <div class="valkka-ws">
        <div class="valkka-ws-icon">
          <svg viewBox="0 0 200 200" width="22" height="22" xmlns="http://www.w3.org/2000/svg">
            ...
            <path fill="white" d="M100,19.81c-44.29,0-80.19,35.9-80.19,80.19s35.9,80.19,80.19,80.19,80.19-35.9,80.19-80.19S144.29,19.81,100,19.81ZM145.96,141.17H54.04V57.8l30.95,4.8v-13.14l60.96,11.03v80.68Z"/>
          </svg>
        </div>
      ...
      >
        <span class="valkka-nav-icon">
          <svg width="13" height="13" viewBox="0 0 13 13" fill="none"><rect x=".5" y=".5" width="5" height="5" rx="1.2" fill="currentColor"/><rect x="7.5" y=".5" width="5" height="5" rx="1.2" fill="currentColor"/><rect x=".5" y="7.5" width="5" height="5" rx="1.2" fill="currentColor"/><rect x="7.5" y="7.5" width="5" height="5" rx="1.2" fill="currentColor"/></svg>
        </span>
      ...
      >
        <span class="valkka-nav-icon">
          <svg width="13" height="13" viewBox="0 0 13 13" fill="none"><circle cx="6.5" cy="4.5" r="2.2" stroke="currentColor" stroke-width="1.2"/><path d="M1.5 12c0-2.761 2.239-5 5-5s5 2.239 5 5" stroke="currentColor" stroke-width="1.2" stroke-linecap="round"/></svg>
        </span>
      ...
      <div style="flex: 1; overflow-y: auto;">
        ...
        >
          ...
          <span :if={!Map.get(repo, :agent_active, false) && Map.get(repo, :dirty_count, 0) > 0} class="valkka-nav-count">
            {repo.dirty_count}
          </span>
        </div>
      ...
      <div class="valkka-sb-footer">
        <div class="valkka-nav">
          <span class="valkka-nav-icon">
            <svg width="13" height="13" viewBox="0 0 13 13" fill="none"><rect x=".5" y=".5" width="12" height="12" rx="2" stroke="currentColor"/><path d="M3 4.5l2.5 2.5L3 9.5" stroke="currentColor" stroke-width="1.2" stroke-linecap="round"/><path d="M7.5 9.5H10" stroke="currentColor" stroke-width="1.2" stroke-linecap="round"/></svg>
          </span>
          <span class="valkka-nav-label">Terminal</span>
        </div>
        <div class="valkka-nav">
          <span class="valkka-nav-icon">
            <svg width="13" height="13" viewBox="0 0 13 13" fill="none"><circle cx="6.5" cy="6.5" r="5" stroke="currentColor"/><path d="M6.5 3.5v3l2 2" stroke="currentColor" stroke-width="1.2" stroke-linecap="round"/></svg>
          </span>

# Känni-0 — The First Usable Version
...
Känni-0 is a real-time multi-repo surface that shows you three things:
...
These all layer on top once the foundation works. Känni-0 is the foundation.
...
14:15  kanni           pushed main → origin/main
```
...
> I open Känni, point it at ~/projects, and immediately see all my repos and what state they're in. No commands needed.
...
> I see changes, I decide to commit. I stage files, write a message, commit, push — all without leaving Känni.
...
1. **The awareness test:** Open Känni alongside your agents. Can you tell what's happening across your repos without running any git commands?

2. **The context test:** When you look at a file diff, does Kerto context change how you think about it?

3. **The action test:** Can you stage, commit, and push without leaving Känni?

4. **The speed test:** Every interaction feels instant. < 200ms for git ops, < 100ms for UI updates.

5. **The stability test:** Leave Känni running for 24 hours watching 5 repos. Zero crashes.

---

## What Comes After Känni-0
